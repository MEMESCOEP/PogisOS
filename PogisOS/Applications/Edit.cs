...
namespace PogisOS.Applications
{
    class Edit
    {
        // Functions
        public void EditFile(string Filepath)
        {
            ...
            gbv.EditFileName = Filepath;
            MIV.StartMIV(Filepath);
        }
    }
    ...
    class MIV
    {
        ...
        public static String miv(String start)
        {
            ...
            GlobalVars gbv = new GlobalVars();
            string Filename = gbv.EditFileName;
        ...
        public static void StartMIV(string Filename)
        {
            ...
            Console.Write("Do you want to open " + Filename + "'s content? (Yes/No) >> ");
            string ans = Console.ReadLine().ToLower();
            if (ans == "yes" || ans.ToLower() == "y")
            {
